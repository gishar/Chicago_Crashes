use chicago;
################################################################################################################## Crash Table
/* The cells with no value in crash_date_est_i are just blank text and not null.
I don't really need to keep crash_date_est_i since it's either esimated a couple days later at the station or is the exact date. 
Either way, it will not affect my analysis since it's not entered so many days later. This gets kicked out from data.
